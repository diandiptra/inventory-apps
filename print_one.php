...
$sql100 = "SELECT * FROM bayar, customer WHERE bayar.kodecust = customer.kode AND bayar.kodecust = $kodecust AND bayar.nota = $nota";
...
<table class="table-print">
  ...
  <tr>
    <td style="width:237px;" colspan="6" align="right">Nama Reseller : <?php echo $nmReseller; ?></td>
  </tr>
