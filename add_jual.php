    ...
    <section class="content">
      <div class="row">
        <div class="col-lg-12">
          ...
          $dataapa = "Penjualan Reseller"; // data
                  ...
                  if (isset($_POST["simpan"])) {
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        $sql2 = "insert into bayar values('$kode','$tglnota','$bayar','$datatotal','$kembalian','$databelitotal','$namaKasir','','$kodecust','$jenisbyr','$noRek','$namaRek')";
                        $insertan = mysqli_query($conn, $sql2);
