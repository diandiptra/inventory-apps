       ...
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $result=mysqli_query($conn,$sql);
              ...
              if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000 && $username != null)) && ($chmod >= 3 || $_SESSION['jabatan'] == 'admin')){
                      ...
                      $sql1 = "update $tabeldatabase set nama='$nama', pa_ssword='$password', nohp='$nohp', alamat='$alamat', tgllahir='$tgllahir', tglaktif='$tglaktif', jabatan='$jabatan',avatar='$avatar' where userna_me='$username'";
