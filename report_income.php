                  ...
                  <div class="row">
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-aqua">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data130, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Semua</p>
                                           </div>
                                           <div class="icon">
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-yellow">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data230, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Tahun Ini</p>
                                           </div>
                                           <div class="icon">
                                              <i class="ion ion-stats-bars"></i>
                    ...
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-green">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data330, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Bulan Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-red">
                                           <div class="inner">
                                               <h3><sup style="font-size: 20px">Rp </sup><?php echo number_format($data430, $decimal, $a_decimal, $thousand).',-'; ?></h3>
                                               <p>Total Hari Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
...
<?php
if($tahun == null || $tahun == "" ){
        $sqla="SELECT no, COUNT( * ) AS totaldata FROM $forward where nota IN (SELECT nota FROM transaksimasukeceran)";
      }else{
        $sqla="SELECT no, COUNT( * ) AS totaldata FROM $forward where nota IN (SELECT nota FROM transaksimasukeceran) and tglbayar LIKE '$tahun-$bulan-%'";
      }
...
?>
  ...
  <?php
$sqlb="SELECT (SUM(total)-SUM(keluar)) AS total FROM $forward WHERE nota IN (SELECT nota FROM transaksimasukeceran) AND tglbayar LIKE '$tahun-$bulan-%'";
...
<?php if($tahun != null || $tahun != ""){ ?>
     ...
     $sql    = "select * from $forward where nota IN (SELECT nota FROM transaksimasukeceran) order by no desc";
 ...
 ?>
     ...
     if ($tahun != null || $tahun != "") {
         ...
         $query1="SELECT * FROM  $forward where nota IN (SELECT nota FROM transaksimasukeceran) and tglbayar like '$tahun-$bulan-%' order by no limit $rpp";
 ...
 <tr>
   ...
   <?php
 $nota = $fill['nota'];
 $sqle="SELECT COUNT( nota ) AS data FROM transaksimasukeceran WHERE nota ='$nota'";
