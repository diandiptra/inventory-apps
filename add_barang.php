...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
    ...
    $kode=$nama=$hargabeli=$hargajual=$keterangan=$kategori=$satuan="";
    $no = $_GET["no"];
    $insert = '1';
   ...
   <div class="container-fluid">
        ...
        <div class="row">
           <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama" maxlength="100">
                  </div>
                </div>
        </div>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          if($chmod >= 3 || $_SESSION['jabatan'] == 'admin'){
                  $sql1 = "update $tabeldatabase set nama='$nama', hargabeli='$hargabeli', hargajual='$hargajual', kategori='$kategori', satuan='$satuan', keterangan='$keterangan' where kode='$kode'";
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
           ...
           $sql2 = "insert into $tabeldatabase values( '$kode','$nama','$hargabeli','$hargajual','$keterangan','$kategori','','','','','$satuan')";
