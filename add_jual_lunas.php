...
$halaman = "add_jual_lunas"; // halaman
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Pelunasan Trx Reseller</h4>
                  </div>
                  <div class="modal-body">
                    <form role="form" action="editlunas" method="get">
                        <?php
                          ...
                          $sql_trxmasuk = "SELECT COUNT( nota ) AS data, kode AS kode FROM transaksimasuk WHERE nota ='$no_nota'";
