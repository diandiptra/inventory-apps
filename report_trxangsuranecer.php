...
$halaman = "report_trxangsuranecer"; // halaman
$dataapa = "Laporan Transaksi Penjualan Pelunasan Eceran"; // data
...
?>
 ...
 <?php } else {}?>
    ...
    <td>
  <?php if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin' || $_SESSION['jabatan'] != 'admin') { ?>
    <button type="button" class="btn btn-info btn-xs no-print" onclick="window.open('print_two.php?nota=<?php echo $nota; ?>', 'Cetak', ' menubar=0, resizable=0,dependent=0,status=0,width=260,height=400,left=10,top=10', '_blank')">Cetak Struk</button>
 <?php } else {}?>
  ...
  <?php } ?>
              ...
              <?php } else {} ?>
                      <div align="right"  style="padding-right:15px"  class="no-print" id="no-print" >
                        ...
                        <a onclick="window.location.href='configuration/config_exportecer?forward=<?php echo $forward; ?>&search=<?php echo $search; ?>'" class="btn btn-default btn-flat" name="cetak" value="export excel"><span class="glyphicon glyphicon-save-file"></span></a></div> <br/>
                      </div>
